...
BOOL Initialize(GL_Window* window, Keys* keys) {
  ...
  if ((!LoadTGA(&textures[0], "Data/BlueFace.tga")) || (!LoadTGA(&textures[1], "Data/Bucket.tga")) || (!LoadTGA(&textures[2], "Data/Target.tga")) || (!LoadTGA(&textures[3], "Data/Coke.tga")) || (!LoadTGA(&textures[4], "Data/Vase.tga")) || (!LoadTGA(&textures[5], "Data/Explode.tga")) || (!LoadTGA(&textures[6], "Data/Ground.tga")) || (!LoadTGA(&textures[7], "Data/Sky.tga")) || (!LoadTGA(&textures[8], "Data/Crosshair.tga")) || (!LoadTGA(&textures[9], "Data/Font.tga"))) {
    return FALSE;
  }
